...
public class ExprDemoStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new expr.ExprDemoRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.ExprDemo.expr")) {
		EPackage.Registry.INSTANCE.put("http://www.ExprDemo.expr", expr.exprDemo.ExprDemoPackage.eINSTANCE);
	}
